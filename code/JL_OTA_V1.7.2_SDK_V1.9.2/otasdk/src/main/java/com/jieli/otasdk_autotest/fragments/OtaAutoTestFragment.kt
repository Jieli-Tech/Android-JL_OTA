...
//                                WebService.stop(context)
        ...
        btn_upgrade.setOnClickListener {
            ...
            if (otaViewModel.getDeviceInfo() == null) {
                ...
                //TODO: 多国语言翻译
                ToastUtil.showToastShort(getString(R.string.need_mandatory_upgrade_no_auto_test))
                testCount = 1
            }
            if (otaViewModel.getDeviceInfo() == null) {
                ToastUtil.showToastShort(getString(R.string.bt_not_connect_device))
                ...
                //TODO: 多国语言翻译
                ToastUtil.showToastLong(getString(R.string.mandatory_upgrade_no_auto_test_recorvery))
                testCount = 1
