...
class SettingsFragment : BaseFragment() {
    ...
    private fun initUI() {
        ...
        //更新SDKVersionName
        tv_sdk_version_content.text = String.format(
            Locale.ENGLISH,
            "%s: V%s",
                    ...
                    this.dialogClickListener = object : DialogClickListener {
                        override fun rightBtnClick(inputText: String?) {
                            inputText?.run {
                                ...
                                this@SettingsFragment.tv_auto_test_input_content.setText(
                                    autoTestCount.toString()
                                )
                                compareSetting()
                            }
                            this@run.dismiss()
                    ...
                    this.dialogClickListener = object : DialogClickListener {
                        override fun rightBtnClick(inputText: String?) {
                            inputText?.run {
                                ...
                                this@SettingsFragment.tv_fault_tolerant_input_content.setText(
                                    faultTolerantCount.toString()
                                )
                                compareSetting()
                            }
                            this@run.dismiss()
